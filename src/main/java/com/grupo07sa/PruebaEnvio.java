...
public class PruebaEnvio {
    ...
    public static void main(String[] args) {
        ...
        //INSERT[pagos:nit=1578217,razon_social=Christian Mamani,email=christian@gmail.com,celular=77382831,trabajador=Dr Ventura,servicio=Ecografia Abdominal,horario=08:30-12:00,tipo_servicio=Medico,costo=0.01,forma_pago=QR,paciente_id=7,ficha_id=1];
        clientSMTP.enviarCorreo("grupo07sa@tecnoweb.org.bo", "HELP[];", "Insertar usuarios...");
    }
}
